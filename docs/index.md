...
_Note: for local deployment see [DEVELOPER](DEVELOPER.md#running-on-localhost-without-docker-compose)_
...
- [Calibration Repository (Postgres)](https://github.com/el-besto/calibration-service/tree/main/src/infrastructure/repositories/calibration_repository/postgres_repository.py)
- [Tag Repository (Postgres)](https://github.com/el-besto/calibration-service/tree/main/src/infrastructure/repositories/tag_repository/postgres_repository.py)
- [Calibration Routes (FastAPI)](https://github.com/el-besto/calibration-service/tree/main/src/drivers/rest/routers/calibration_router.py)
- [Tag Routes (FastAPI)](https://github.com/el-besto/calibration-service/tree/main/src/drivers/rest/routers/tag_router.py)
- [Calibration Api integration tests](https://github.com/el-besto/calibration-service/tree/main/tests/integration/drivers/rest/test_calibration_api.py)
- [Tagging Api integration tests](https://github.com/el-besto/calibration-service/tree/main/tests/integration/drivers/rest/test_tagging_api.py)
...
- [test_api_use_cases_e2e.py](https://github.com/el-besto/calibration-service/tree/main/tests/e2e/test_api_use_cases_e2e.py) take home assignment uc1-4 tests
- [test_tag_archiving_e2e.py](https://github.com/el-besto/calibration-service/tree/main/tests/e2e/test_tag_archiving_e2e.py) take home assignment uc5
...
<img src="assets/ERD.png" alt="ERD" width="500">
...
curious about the structure, I nerded out a bit more in the [ARCHITECTURE](ARCHITECTURE.md) section.
...
- [Developer Guide](DEVELOPER.md) - Day-to-day development workflows
- [Database Management](DATABASE.md) - Detailed information about database management operations
- [Architecture Inspiration](ARCHITECTURE.md) - System design and software architecture inspiration
- [Testing Approach](TESTS.md) - How to execute project tests and the packages used
- [CI/CD](WORKFLOWS.md) - Description of CI/CD workflows
